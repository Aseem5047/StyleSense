...
const ProductDetail = () => {
	...
	return (
		<div className="grid grid-cols-1 lg:grid-cols-2 3xl:grid-cols-1 h-full w-full 3xl:w-1/2 items-center justify-center gap-4 lg:gap-7 px-5 lg:px-7 pb-4 pt-0">
			{/* product image */}
			<img
				src={image[0]}
				alt={title}
